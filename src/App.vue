    ...
    render() {
        return h("div", [
            ...
            h("div", [
                ...
                h(ButtonCustom, { icon: "quest", theme: "question" }),
                h(ButtonCustom, { icon: "chevron", theme: "primary" }),
                h(ButtonCustom, { icon: "google", theme: "danger" }),
                h(ButtonCustom, { icon: "vk", theme: "info" }),
                h(ButtonCustom, { icon: "class", theme: "action" }),
